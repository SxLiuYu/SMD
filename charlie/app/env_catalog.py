...
ENTRIES: list[EnvEntry] = [
    ...
    EnvEntry("XIAOZHI_VAD_THRESHOLD", group="tuning", tunable=True,
    ...
    EnvEntry("ASSISTANT_KID_INTENT_FAILURE_THRESHOLD", group="tuning", tunable=True,
             description="意图分类熔断阈值"),
    EnvEntry("ASSISTANT_KID_INTENT_FAILURE_COOLDOWN", group="tuning", tunable=True,
             description="意图分类熔断冷却秒数"),
    EnvEntry("ASSISTANT_KID_RETRY_AFTER_CAP", group="tuning", tunable=True,
